...
| **Fine-tuning** ([Fine-Tuning LLMs](Fine-Tuning%20LLMs.md)) | you need *behavior/format/domain* baked in (e.g. better SQL generation) | prompting + tools already hit the bar |
