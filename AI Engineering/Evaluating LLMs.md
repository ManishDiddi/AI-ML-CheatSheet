...
**Where it fits:** The measurement layer of AI engineering — how you choose a model, catch regressions, and prove an LLM app is good enough to ship. Builds directly on [LLM](LLM.md) (decoding, hallucination) and [RNN · LSTM · Transformers](../Interview%20Prep/RNN%20%C2%B7%20LSTM%20%C2%B7%20Transformers.md) (tokenization, embeddings for BERTScore).
